...
public class CopyOfHeightChart extends AbstractGraChart {
	...
	public GraphicalView execute(Context context) {
	    ...
	    PointStyle[] styles = new PointStyle[] { PointStyle.POINT, PointStyle.POINT, PointStyle.POINT, PointStyle.POINT, PointStyle.POINT, PointStyle.POINT};
	    XYMultipleSeriesRenderer renderer = buildRenderer(colors, styles);
